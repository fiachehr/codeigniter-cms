<?php
   ...
   $newsSoTitle = set_value('newsSoTitle',$news['newsSoTitle']);		

   $newsRTitle = set_value('newsRTitle',$news['newsRTitle']);

   $newsTitle = set_value('newsTitle',$news['newsTitle']);

   $newsArthur = set_value('newsArthur',$news['newsArthur']);

   $newsSummery = set_value('newsSummery',$news['newsSummery']);

   $newsBody = set_value('newsBody',$news['newsBody']);

   $newsKeywords = set_value('newsKeywords',$news['newsKeywords']);
   $newsRecommanded = null;
   $images = null;
   if($news['newsRecommanded'] == "1"){
      $newsRecommanded = "checked";
   }
   ...
   if($news['imageCount'] > 0){

      for($i = 0 ; $i < $news['imageCount'] ; $i++){

         $images .= "<div data-action=\"removeServerImage\" data-id=\"".$i."\" data-module=\"news\" data-guid=\"newsGUID\" ><img src=\"".base_url()."assets/uploads/news/".$newsGUID."--".$i.".jpg\" /></div>"; 
            ...
            <div class="box box-primary">
               ...
               <div class="box-header with-border">
                  ...
                  <h3 class="box-title"><?=$pageTitle;?></h3>
					...
					<form role="form" action="<?php echo base_url();?>News/editNews/<?=$newsGUID;?>/<?=$page;?>" method="post" enctype="multipart/form-data">

                  <input type="hidden"  name="newsGUID"  value="<?php echo $newsGUID; ?>">

                  <input type="hidden"  name="imageCount"  value="<?php echo $news['imageCount']; ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="multi-checkbox">
                           ...
                           <input type="checkbox" name="newsRecommanded" class="flat-red" value="1" <?=$newsRecommanded;?> > انتخاب به عنوان خبر ویژه
                     ...
                     <div class="form-group">
                        ...
                        <div class="multi-checkbox">
                           ...
                           <input type="radio" name="newsStatus" value="0" class="flat-red" <?=$statusChecked[0];?>>
                           ...
                           <input type="radio" name="newsStatus" value="1" class="flat-red" <?=$statusChecked[1];?> >
