<?php
   $financialTitle = set_value('financialTitle',$financial['financialTitle']);		
   $financialPercent = set_value('financialPercent',$financial['financialPercent']);
   $financialStartDate = set_value('financialStartDate',$financial['financialStartDate']);
   $financialExpireDate = set_value('financialExpireDate',$financial['financialExpireDate']);

   $statusChecked = array("checked","");
   $typeSelected = array("selected","");

   if($financial['financialStatus'] == "1"){
    $statusChecked = array("","checked");
   }
...
if($resultMessage['result'] == "Alert"){
    if($this->input->post('financialStatus') == "1"){
        $statusChecked = array("","checked");
    }
    if($this->input->post('financialType') == "-"){
        $typeSelected = array("","checked");
    }
         ...
         <div class="col-md-12">
            <div class="box box-primary">
               <div class="box-header with-border">
				...
				<form role="form" action="<?php echo base_url();?>Shop/editFactorFinancial/<?=$financial['financialID'];?>" method="post" enctype="multipart/form-data">
                  <div class="box-body">
