               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="cart-section">
                        ...
                        <div class="welcome-user">
                           ...
                           <p>
                               <span> <?=$this->session->userdata['userName'];?> </span>عزیز به سایت <strong> بیک </strong> خوش آمدید
                           </p>
                           <?php } ?>
                        </div>
                     </div>
                  ...
                  <div class="col-md-6">
                     <div class="top-line-left">
                        <ul>
                           <li><i class="fa fa-phone"></i><span> صدای مشتری 74819-021</span></li>
                           <li>
                           ...
                           <?php }else{ ?>
                              ...
                              <ul>
                                 <li><a href="<?=base_url()."UserSM/changePassword";?>"> تغییر رمز عبور </a></li>
                              </ul>
                           </li>
                           <li>
